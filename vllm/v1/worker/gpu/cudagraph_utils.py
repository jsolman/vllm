                ...
                for desc in descs:
                    ...
                    if (
                        ...
                        with torch.cuda.graph(
                            graph,
                            self.pool,
                            # Upstream: microbatch threads capture on a dedicated
                            # stream; Ours: thread_local capture_error_mode so
                            # unrelated in-flight work on other streams doesn't
                            # abort capture on Thor/SM110.
